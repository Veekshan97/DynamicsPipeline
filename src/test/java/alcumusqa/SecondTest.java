...
public class SecondTest extends Base {
	...
	String leadFirstName = "leadFN" + currentTime;
	String leadLastName = "leadLN" + currentTime;
	...
	public void createClinetAccount() throws InterruptedException {
		...
		accountsPage.clickOnNew();
		accountsPage.enterAccountName().sendKeys(clientAccountName);
		accountsPage.enterAddressOneStreetOne();
		accountsPage.clickOnSave();

		// quick search
		accountsPage.clickOnAccounts();
		accountsPage.enterQuickFind().sendKeys(clientAccountName);
		accountsPage.startSearch();
		accountsPage.clickOnResult();
		
		// creating contact creation
		accountsPage.clickOnContactsTab();
		accountsPage.clickOnNewContact();
		accountsPage.enterContactsFirstName().sendKeys(clientFirtsName);
		accountsPage.enterContactsLastName().sendKeys(clientLastName);
		accountsPage.enterContactsEmailAddress().click();
		Thread.sleep(1000);
		accountsPage.enterContactsEmailAddress().sendKeys(clientEmail);
		accountsPage.enterContactsEmailAddress().sendKeys(Keys.TAB);
		accountsPage.clickOnOkButton();
		accountsPage.clickOnSaveAndClose();

		// account profile creation
		accountsPage.clickOnSummaryTab();
		accountsPage.clickAccountProfileIcon();
		accountsPage.clickNewAccountProfile();
		accountsPage.enterBrandlookUpValue();
		accountsPage.selectBrandlookUpValue();
		accountsPage.enterProfilelookUpValueAsClient();
		accountsPage.selectProfilelookUpValueAsClient();
		accountsPage.onAXAccountNumber();
		accountsPage.clickOnSave();

		// creating an account
		accountsPage.clickOnAccounts();
		accountsPage.clickOnNew();
		accountsPage.enterAccountName().sendKeys(supplierAccountName);
		accountsPage.enterAddressOneStreetOne();
		accountsPage.clickOnSave();
		
		// code for quick search
		accountsPage.clickOnAccounts();
		accountsPage.enterQuickFind().sendKeys(supplierAccountName);
		accountsPage.startSearch();
		accountsPage.clickOnResult();
		...
		accountsPage.clickOnContactsTab();
		accountsPage.clickOnNewContact();
		accountsPage.enterContactsFirstName().sendKeys(supplierFirtsName);
		accountsPage.enterContactsLastName().sendKeys(supplierLastName);
		accountsPage.enterContactsEmailAddress().click();
		Thread.sleep(1000);
		accountsPage.enterContactsEmailAddress().sendKeys(supplierEmail);
		accountsPage.enterContactsEmailAddress().sendKeys(Keys.TAB);
		accountsPage.clickOnOkButton();
		accountsPage.clickOnSaveAndClose();
		...
		accountsPage.enterBrandlookUpValue();
		accountsPage.selectBrandlookUpValue();
		accountsPage.enterProfilelookUpValueAsSupplier();
		accountsPage.selectProfilelookUpValueAsSupplier();
		accountsPage.onAXAccountNumber();
		accountsPage.clickOnSave();
		
		//Campaign creation 
		campaignsPage.clickOnCampaigns();
		accountsPage.clickOnNew();
		campaignsPage.enterCampaignName().sendKeys(campaignName);
		campaignsPage.enterCampaignType();
		campaignsPage.seacrhForClient().sendKeys(clientAccountName);
		campaignsPage.clickOnResult();
		campaignsPage.SelectPreNoteDate();
		accountsPage.enterBrandlookUpValue();
		accountsPage.selectBrandlookUpValue();
		accountsPage.clickOnSave();
		Thread.sleep(8000);
